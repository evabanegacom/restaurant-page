...
let child; // child process which runs the user's code
const ignoreExtensions = ['.dirtydb', '.db', '.styl', '.css'];
let ignoreFiles = ['node_modules'];
...
function watchFiles(files, callback) {
  const config = { persistent: true, interval: 25 };
  files.forEach((file) => {
    ...
    fs.watchFile(file, config, (curr, prev) => {
